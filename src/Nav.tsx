        ...
        {/*<li
          ...
          <li>
              <span className="relative cursor-pointer" onClick={props.changeMode}>
                ...
                <span className="flex justify-center items-center absolute w-4 h-4 mt-1 ml-1 bg-white rounded-full shadow inset-y-0 left-0 focus-within:shadow-outline transition-transform duration-300 ease-in-out dark:transition-transform dark:duration-300 dark:ease-in-out dark:bg-white dark:transform dark:translate-x-full">
